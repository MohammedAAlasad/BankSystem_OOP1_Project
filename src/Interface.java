...
public class Interface {
    ...
    public static void main(String[] args) {
        ...
        bankFunctions.addusers(fakeuser);
        Accounts fakeaccount = new Accounts("U1", 20000);
                    ...
                    do {
                        ...
                        switch (user_menu_choice) {
                            ...
                            case 2:
                                ...
                                Accounts a = new Accounts("U" + bankFunctions.users.size(), initialbalance);
                                u.setAccount(a);
            ...
            do {
                ...
                switch (employee_menu_choice) {
                    ...
                    case 1:
                        ...
                        bankFunctions.addusers(newUser);

                        System.out.println("Initial Balance:");
                        initialbalance = input.nextDouble();
                        input.nextLine();

                        Accounts newAcc = new Accounts("U" + bankFunctions.users.size(),
                        initialbalance);
 ...
 do {
                        ...
                        switch (admin_function_choice) {
                            ...
                            case 3:
                                ...
                                int showuser = input.nextInt();
                                input.nextLine();
                                bankFunctions.showAccountByAdmin(showuser);  // YOUR ORIGINAL LOGIC
                                break;
                            ...
                            case 4:
                                ...
                                input.nextLine();
                                bankFunctions.showUserStat(showemp);
                                break;
